    ...
    <div className="md:max-w-[95%] mx-auto px-4 py-15 mt-[35px] text-gray-800">
      ...
      <section>
        ...
        <p className="mt-2">
          ...
          🌐 Website: <a href="https://medcapsky.com" target="_blank" rel="noopener noreferrer" className="text-blue-600 underline">www.medcapsky.com</a><br />
           <img className="inline w-[1.3%] md:w-[1.3%] " src={Whatsapp} /> Whatsapp: <a href="https://wa.me/919208432221?text=Hi%20MedcapSky%2C%20I%20have%20a%20questio"
                      target='_blank'
